...
//
      ...
      case MenuMetadata.ITEM_ENTRY:
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP
          ...
          dialog.show();
            ...
            Log.e(TAG,"===onNavigationItemSelected==dialog.show(===");
        } else {
          ...
          if (isLocked()) {
            ...
            Log.e(TAG,"===onNavigationItemSelected==closeIfNotLocked===");
        }

        break;
      case MenuMetadata.ITEM_INTENT:
          Log.e(TAG,"===onNavigationItemSelected==ITEM_INTENT===");
  ...
  public void onNavigationItemActionClick(MenuItem item) {
      Log.e(TAG,"======onNavigationItemActionClick========"+item.getTitle());
    String title = item.getTitle().toString();
    MenuMetadata meta = dataUtils.getDrawerMetadata(item);
